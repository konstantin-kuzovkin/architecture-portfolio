...
All examples are reconstructed and sanitised for demonstration purposes.
...
• confidential database structures;
• internal Kafka topic names;
...
They are not copies of production documentation.
...
5. Internal service names.
6. Internal network information.
